...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        // Animate in the movies when the page loads and show cast when the mouse enters the tile
        $(document).ready(function () {
          $('.movie-tile').hide().first().show("fast", function showNext() {
            $(this).next("div").show("fast", showNext);
          });
          function showCast(){
          $(this).find('h4').slideToggle();}
          $('.movie-tile').on('mouseenter', showCast);
          $('.movie-tile').on('mouseleave', showCast);
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#">My Favourite TV Shows</a>
          </div>
        </div>
      </div>
    </div>
